...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FILEDESCRIPTORPROTO = _descriptor.Descriptor(
    ...
    fields=[
      ...
      _descriptor.FieldDescriptor(
        name='service.py', full_name='google.protobuf.FileDescriptorProto.service.py', index=7,
        number=6, type=11, cpp_type=10, label=3,
        has_default_value=False, default_value=[],
        message_type=None, enum_type=None, containing_type=None,
        is_extension=False, extension_scope=None,
        serialized_options=None, json_name='service.py', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
      _descriptor.FieldDescriptor(
  ...
  _FILEDESCRIPTORPROTO.fields_by_name['service.py'].message_type = _SERVICEDESCRIPTORPROTO

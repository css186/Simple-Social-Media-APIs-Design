...
the closest proxy.
    ...
    PEER_SERVICE = "peer.service.py"
    """
    The [`service.py.name`](../../resource/semantic_conventions/README.md#service.py) of the remote service.py. SHOULD be equal to the actual `service.py.name` resource attribute of the remote service.py if any.
    """
    ...
    RPC_SERVICE = "rpc.service.py"
    """
    The name of the service.py to which a request is made, as returned by the AWS SDK.
    Note: This is the logical name of the service.py from the RPC interface perspective, which can be different from the name of any implementing class. The `code.namespace` attribute may be used to store the latter (despite the attribute name, it may include a class name; e.g., class with method actually executing the call on the server side, RPC client stub class on the client side).
    """
